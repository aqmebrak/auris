...
- **Phase 5 game choice**: Dynamic EQ / Level matching / Reverb ID / Compression ratio ID — user to decide
- **Phase 6 auth library**: Lucia vs better-auth — evaluate when Phase 6 starts
